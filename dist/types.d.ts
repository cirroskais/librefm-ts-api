...
export type LastFMAlbumAddTagsParams = LastFMRequestParams<LastFMParam> & LastFMAlbumParams & Readonly<{
    tags: string | string[];
}>;
export type LastFMAlbumGetInfoParams = LastFMRequestParams<LastFMBooleanNumberOrVoid> & LastFMAlbumParams & LastFMAlbumOptionalParams & Readonly<{
    lang?: string;
    username?: string;
}>;
export type LastFMAlbumGetTagsParams = LastFMRequestParams<LastFMBooleanNumberOrVoid> & LastFMAlbumParams & LastFMAlbumOptionalParams & Readonly<{
    user?: string;
}>;
...
export type LastFMAlbumRemoveLastFMTagParams = LastFMRequestParams<LastFMParam> & LastFMAlbumParams & Readonly<{
    tag: string;
}>;
export type LastFMAlbumSearchParams = LastFMRequestParams<number | void> & Readonly<{
    page?: number;
    album: string;
    limit?: number;
}>;
...
export type LastFMArtistParams = LastFMRequestParams<LastFMParam> & Readonly<{
    artist: string;
}>;
export type LastFMArtistAddTagsParams = LastFMRequestParams<LastFMParam> & LastFMArtistParams & Readonly<{
    tags: string | string[];
}>;
export type LastFMArtistGetInfoParams = LastFMRequestParams<LastFMBooleanNumberOrVoid> & Readonly<{
    lang?: string;
    mbid?: string;
    artist: string;
    username?: string;
...
export type LastFMArtistGetSimilarParams = LastFMRequestParams<LastFMVoidOrNumber> & Readonly<{
    mbid?: string;
    limit?: number;
    artist: string;
    autocorrect?: 0 | 1;
}>;
export type LastFMArtistGetTagsParams = LastFMRequestParams<LastFMBooleanNumberOrVoid> & Readonly<{
    mbid?: string;
    user?: string;
    artist: string;
    autocorrect?: 0 | 1;
}>;
export type LastFMArtistGetTopAlbumsParams = LastFMRequestParams<LastFMVoidOrNumber> & Readonly<{
    mbid?: string;
    page?: number;
    limit?: number;
    artist: string;
...
export type LastFMArtistGetTopTagsParams = LastFMRequestParams<LastFMBooleanNumberOrVoid> & Readonly<{
    mbid?: string;
    artist: string;
    autocorrect?: 0 | 1;
}>;
export type LastFMArtistGetTopTracksParams = LastFMRequestParams<LastFMVoidOrNumber> & Readonly<{
    mbid?: string;
    page?: number;
    limit?: number;
    artist: string;
...
export type LastFMArtistRemoveLastFMTagParams = LastFMRequestParams<LastFMParam> & Readonly<{
    tag: string;
    artist: string;
}>;
export type LastFMArtistSearchParams = LastFMRequestParams<number | void> & Readonly<{
    page?: number;
    limit?: number;
    artist: string;
}>;
...
export type LastFMAuthGetMobileSessionParams = LastFMRequestParams<LastFMParam> & Readonly<{
    username: string;
    password: string;
}>;
export type LastFMAuthGetSessionParams = LastFMRequestParams<LastFMParam> & Readonly<{
    token: string;
}>;
...
export type LastFMChartParams = LastFMRequestParams<number | void> & Readonly<{
    page?: number;
    limit?: number;
}>;
...
export type LastFMGeoGetTopArtistsParams = LastFMRequestParams<number | void> & Readonly<{
    page?: number;
    limit?: number;
    country: string;
}>;
export type LastFMGeoGetTopTracksParams = LastFMGeoGetTopArtistsParams & Readonly<{
    location?: string;
}>;
...
export type LastFMLibraryGetArtistsParams = LastFMRequestParams<number | void> & Readonly<{
    user: string;
    page?: number;
    limit?: number;
}>;
...
export type LastFMTagParams = LastFMRequestParams<number | void> & Readonly<{
    tag: string;
}>;
...
export type LastFMTagGetInfoParams = LastFMRequestParams<number | void> & LastFMTagParams & Readonly<{
    lang?: string;
}>;
...
export type LastFMTrackParams = LastFMRequestParams<number | void> & Readonly<{
    track: string;
    artist: string;
}>;
...
export type LastFMTrackAddTagsParams = LastFMTrackParams & Readonly<{
    tags: string | string[];
}>;
export type LastFMTrackGetInfoParams = LastFMTrackParams & LastFMTrackOptionalParams & Readonly<{
    username?: string;
}>;
export type LastFMTrackGetSimilarParams = LastFMTrackParams & LastFMTrackOptionalParams & Readonly<{
    limit?: number;
}>;
export type LastFMTrackGetTagsParams = LastFMTrackParams & LastFMTrackOptionalParams & Readonly<{
    user?: string;
}>;
export type LastFMTrackGetTopTagsParams = LastFMTrackParams & LastFMTrackOptionalParams;
export type LastFMTrackRemoveTagParams = LastFMTrackParams & Readonly<{
    tag: string;
}>;
export type LastFMTrackScrobbleParams = LastFMTrackParams & Readonly<{
    timestamp: number;
    album?: string;
    context?: string;
    streamId?: string;
...
export type LastFMTrackSearchParams = LastFMRequestParams<number | void> & Readonly<{
    page?: number;
    limit?: number;
    track: string;
    artist?: string;
}>;
export type LastFMTrackUpdateNowPlayingParams = LastFMTrackParams & Readonly<{
    mbid?: string;
    album?: string;
    context?: string;
    duration?: number;
...
export type LastFMUserParams = LastFMRequestParams<LastFMParam | number | void | boolean> & Readonly<{
    user: string;
}>;
...
export type LastFMUserGetFriendsParams = LastFMUserParams & LastFMUserOptionalParams & Readonly<{
    recenttracks?: boolean;
}>;
export type LastFMUserGetLovedTracksParams = LastFMUserParams & LastFMUserOptionalParams;
export type LastFMUserGetPersonalTagsParams = LastFMUserParams & LastFMUserOptionalParams & Readonly<{
    tag: string;
    taggingtype: 'artist' | 'album' | 'track';
}>;
export type LastFMUserGetRecentTracksParams = LastFMUserParams & LastFMUserOptionalParams & Readonly<{
    to?: string;
    from?: string;
    extended?: 0 | 1;
}>;
export type LastFMUserGetTopParams = LastFMUserParams & LastFMUserOptionalParams & Readonly<{
    period?: 'overall' | '7day' | '1month' | '3month' | '6month' | '12month';
}>;
export type LastFMUserGetTopTagsParams = LastFMRequestParams<string | number | void> & Readonly<{
    user: string;
    limit?: number;
}>;
export type LastFMUserGetWeeklyParams = LastFMRequestParams<string | number | void> & Readonly<{
    to?: string;
    user: string;
    from?: string;
}>;
